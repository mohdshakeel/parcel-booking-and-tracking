...
// BookParcelForm
// Props:
// - onSubmit: function(formData) => Promise|void  (optional)
// Example: <BookParcelForm onSubmit={data => console.log(data)} />
...
export default function Booking() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl ring-1 ring-slate-200">
